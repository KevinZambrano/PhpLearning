<?php
 ...
 class Usuario {
   ...
   public function __construct($correo, $nombre, $apellidos,$genero,$password, $fecha_registro) {
      $this->correo = $correo;
      $this->nombre = $nombre;
      $this->apellidos = $apellidos;
      $this->genero = $genero;
   ...
   public function guardar(){
     $conexion = new Conexion();
        ...
        $consulta = $conexion->prepare('INSERT INTO ' . self::TABLA .' (correo, nombre, apellidos, genero, password, fecha_registro) VALUES(:correo, :nombre, :apellidos, :genero, :password, :fecha_registro)');
